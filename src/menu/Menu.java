...
public class Menu {
	...
	private static final String INSIRA_JOGABILIDADE_MSG = "Insira a jogabilidade do jogo :";
	...
	public static void main(String[] args) {
		...
		do {
			...
			case VENDER_JOGOS_USUARIO_OP:
				...
				} while (!"acabou".equals(jogabilidade));
			...
			case IMPRIMIR_RELATORIO_USUARIOS_OP:
				System.out.println(loja.getRelatorioUsuarios());
				break;
