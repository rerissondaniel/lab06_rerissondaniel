...
public class JogoTest {
	...
	public void setup() {
		...
		jogo1 = new Rpg("Final Fantasy X", 5000, 0, jogabilidade);

		jogabilidade = new HashSet();
		jogabilidade.add(Jogabilidade.OFFLINE);
		jogo1 = new Plataforma("Valkyrie Profile", 20000, 0, null);
	}

	@Test
	public void testHashCodeEquals() {
		Assert.assertNotSame(jogo1, jogo2);
		aux = new Luta(jogo1.getNome(), jogo1.getPreco(),
				jogo1.getMaiorScore(), jogo1.getJogabilidade());
